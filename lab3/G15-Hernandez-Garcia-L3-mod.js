...
console.log("Ramon Hernandez Garcia\n"); //Mi nombre

console.log("G15 - Laboratorio 3: Tabla de unidades binarias"); //Cabecera
...
function unidad (e) { //Esta funcion usa la variable e para definir el prefijo necesario a la tabla
	if (e == 10) { //Si vale 10 devuelve Kibi
		...
		return "Yobi";
	} else if (e == 90) { //Si vale 90 devuelve Bronto
		return "Bronto";
	} else if (e == 100) { //Si vale 100 devuelve Geop
		return "Geop";
...
i=10;
while (i<=100) { //Se ejecuta 10 veces (de i=10 a i=100)
